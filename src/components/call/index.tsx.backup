      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <header className="px-6 py-4">
          <div className="flex items-center gap-3">
            ...
            <span className="font-semibold text-white text-lg">rapidscreen</span>
          </div>
        </header>
        ...
        <main className="flex-1 flex items-center justify-center p-8">
          <div className="flex gap-12 items-start max-w-5xl w-full">
            ...
            <div className="flex-1">
              <div className="relative bg-gray-900/80 backdrop-blur-sm rounded-2xl overflow-hidden aspect-[4/3] shadow-2xl border border-white/10">
                {hasVideo ? (
                  <video
                    ref={videoRef}
                    autoPlay
                  ...
                  <div className="w-full h-full flex items-center justify-center">
                    <div className="w-24 h-24 rounded-full bg-gray-700/50 flex items-center justify-center border border-white/20">
              ...
              <div className="flex gap-2 mt-4 flex-wrap">
                <select
                  ...
                  className="flex-1 min-w-[150px] appearance-none bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg px-3 py-2 text-sm text-white cursor-pointer hover:bg-white/20 transition-colors truncate"
                >
                ...
                >
                  {devices.speakers.map(speaker => (
                    <option key={speaker.deviceId} value={speaker.deviceId} className="bg-gray-900 text-white">
            ...
            {/* Join Panel */}
            <div className="w-80 flex flex-col items-center text-center bg-white/5 backdrop-blur-md rounded-2xl p-8 border border-white/10">
              ...
              <div className="relative mb-3">
                <div className="w-24 h-24 rounded-full overflow-hidden ring-4 ring-violet-500/30 shadow-lg shadow-violet-500/20">
                  <Image
              ...
              <p className="text-white/70 mb-6">
                <span className="font-medium text-white">{interviewerName}</span> is in the call
              </p>
              ...
              {!isAnonymous && (
                <div className="w-full space-y-3 mb-6">
                  <Input
                    ...
                    className="w-full text-center bg-white/10 border-white/20 text-white placeholder:text-white/50"
                  />
                  <Input
                    type="email"
              ...
              <Button
                ...
                className="w-full bg-violet-600 hover:bg-violet-700 text-white px-8 py-3 rounded-lg font-medium text-base shadow-lg shadow-violet-500/30 transition-all hover:shadow-xl hover:shadow-violet-500/40 disabled:opacity-50"
              >
                {isConnecting ? (
                  <>
        ...
        {/* Footer */}
        <footer className="px-6 py-3 text-center text-sm text-white/50">
          {interviewName}
        </footer>
      </div>
    </div>
...
function Call({ interview }: InterviewProps) {
  ...
  // Always use Alex as the interviewer (ignore database interviewer images)
  // This ensures consistent branding with the new Alex avatar
  useEffect(() => {
    // Always use Alex - the default values are already set
    // No need to fetch from database as we want Alex for all interviews
    setInterviewerImg(DEFAULT_INTERVIEWER_IMAGE);
    setInterviewerName(DEFAULT_INTERVIEWER_NAME);
  }, []);
      ...
      <div className="min-h-screen relative overflow-hidden">
        ...
        <div className="relative z-10 min-h-screen flex items-center justify-center">
          <div className="text-center bg-white/5 backdrop-blur-md rounded-2xl p-12 border border-white/10">
            ...
            <p className="text-white/70">You have already responded to this interview.</p>
          </div>
        </div>
      </div>
    );
  ...
  if (isEnded && !isPracticing) {
    return (
      <div className="min-h-screen relative overflow-hidden">
        <ParticlesBackground />
        <div className="relative z-10 min-h-screen flex items-center justify-center">
          <div className="text-center max-w-md bg-white/5 backdrop-blur-md rounded-2xl p-12 border border-white/10">
            {isFeedbackSubmitted ? (
              <>
                <CheckCircleIcon className="h-20 w-20 text-green-500 mx-auto mb-6" />
                <h1 className="text-3xl font-bold mb-3 text-white">Thank you!</h1>
              ...
              <>
                <CheckCircleIcon className="h-20 w-20 text-green-500 mx-auto mb-6" />
                <h1 className="text-3xl font-bold mb-3 text-white">Interview Complete!</h1>
                <p className="text-white/70 mb-8 text-lg">
                  Your interview has been submitted successfully.
                </p>
                
                <p className="text-white/50 mb-4">We'd love to hear your feedback!</p>
                <AlertDialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
                  <AlertDialogTrigger asChild>
                    <Button className="bg-violet-600 hover:bg-violet-700 text-white px-8 py-3 rounded-lg font-medium shadow-lg shadow-violet-500/30">
                      Provide Feedback
                    </Button>
                  </AlertDialogTrigger>
                  <AlertDialogContent className="bg-gray-900 border-white/10">
                    <AlertDialogHeader>
                      <AlertDialogTitle className="text-white">Interview Feedback</AlertDialogTitle>
                    </AlertDialogHeader>
                    <FeedbackForm 
